...
To use these stylesheets, rename the files and coarco_omega with the name of your theme.
...
coarco_omega-alpha-default.css
...
coarco_omega-alpha-default-narrow.css  
...
coarco_omega-alpha-default-normal.css
...
coarco_omega-alpha-default-wide.css
