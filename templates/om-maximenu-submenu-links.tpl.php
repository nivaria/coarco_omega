 ...
 * - $om_user_info: rendered span or a tag with attributes
...
<?php if (!empty($permission)): ?>   
  <li id="om-leaf-<?php print $code . '-' . $key; ?>" class="<?php print om_maximenu_link_classes($content, $permission, $count, $total); ?>">
    <?php if (!empty($om_user_info)): ?>
      <?php print $om_user_info; ?>
    <?php endif; ?>      
    <?php print $om_link; ?>
    <?php print theme('om_maximenu_submenu_content', array('content' => $content['content'], 'maximenu_name' => $maximenu_name, 'key' => $key, 'skin' => $skin)); ?>      
  </li>
<?php endif; ?>  
